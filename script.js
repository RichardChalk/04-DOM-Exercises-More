// ----------------------------------------------------------------------------------------------------------------
//  1.  Lägg till en eventlyssnare på knappen med id "button-1" som kör en funktion när man klickar på knappen.
//      Funktionen som körs när man klickar på knappen ska läsa texten från text-input:en med id "text" och logga
//      den texten i konsolen med console.log
...
// Lärare lösning -  Lärare lösning -  Lärare lösning -  Lärare lösning -  Lärare lösning - 

// Sämre lösning tycker jag!!!!
...
// AppendParagraph(createP("Function text to output to P tag"));
